...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Илья\IdeaProjects\Lesson_Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Илья\IdeaProjects\Lesson_Python\venv\Scripts\deactivate.nu'
